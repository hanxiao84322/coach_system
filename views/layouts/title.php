...
<div class="top">
    <div class="time_login">
        ...
        <p class="fr login_box"><?php if (Yii::$app->admin->isGuest) {?><a href="<?= Url::to('/user/login')?>">登录</a><?php } else { ?><a href="<?= Url::to('/user/logout')?>">登出</a><?php }?> | <a href="javascript:;">加入收藏</a></p>
    </div>
</div>
<!--top-->
<!--logo search-->
