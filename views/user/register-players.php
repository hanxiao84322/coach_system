                    ...
                    <div class="form_input">
                        <div class="divp_pt">
                            ...
                            <table cellpadding="0" cellspacing="0" class="fixed_information">
                                ...
                                <tr>
                                    <td></td>
                                    <td><input name="train_id" type="hidden" value="<?= $train_id?>"><input type="submit" value="保 存" class="fixe_btn"/><a href="<?= \yii\helpers\Url::to(['/train/apply', 'id' => $train_id])?>">填写完成</a></td>
                                </tr>
                            </table>
                            <?php ActiveForm::end(); ?>
                        </div>
