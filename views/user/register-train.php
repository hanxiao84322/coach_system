                    ...
                    <div class="form_input">
                        <div class="divp_pt">
                            ...
                            <table cellpadding="0" cellspacing="0" class="fixed_information">
                                ...
                                <tr>
                                    <td></td>
                                    <td><input name="user_id" type="hidden" value="<?= $user_id?>"><input type="submit" value="保 存" class="fixe_btn"/><a href="<?= \yii\helpers\Url::to('/user/register-vocational')?>">添加执教信息</a></td>
                                </tr>
                            </table>
                            <?php ActiveForm::end(); ?>
                        </div>
