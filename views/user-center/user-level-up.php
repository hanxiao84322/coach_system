                    ...
                    <td valign="top">
                        <div class="content_box">
                            ...
                            <div class="conbox_set">
                                ...
                                <h3 class="jjfc_set21"><span class="fl">我的晋级概况</span><span class="fr span_set">我的晋级条件[<?= \app\models\TrainUsers::getAppraiseResultByUserIdAndLevelId(Yii::$app->user->id, Yii::$app->user->identity->level_id)?>]</span></h3>
                                <div class="sj_six2" style="height:288px;">
                                    <ul>
                                        <li><div class="div_box"><p class="shen_blue">注册积分</p><span>60<b>分</b></span></div><div class="progres">已注册<span></span></div></li>
                                        <li><div class="div_box"><p class="qian_blue">晋升积分</p><span><?= $data['levelUpInfo']['scoreCurrent']?><b>分</b></span></div><div class="progres"><?php if($data['levelUpInfo']['scoreDiff'] <=0) { echo "已达标"; } else { echo "距下一等级" . $data['levelUpInfo']['creditDiff'] . "积分";}?><span></span></div></li>
                                        <li><div class="div_box"><p class="qian1_blue">综合评分</p><span class="fz20"><?= $data['levelUpInfo']['creditCurrent']?></span></div><div class="progres"><?php if($data['levelUpInfo']['creditDiff'] <=0) { echo "已达标"; }  else { echo "下一等级要求" . $data['levelUpInfo']['creditDiff'];}?><span></span></div></li>
                                    ...
                                    <?php if ($data['levelUpInfo']['buttonStyle'] == 'true') {?>
                                        <a href="javascript:;" class="btnbj1">恭喜您获得教练员晋升资格,点击这里进行<?= $data['levelUpInfo']['levelNameNext']?>教练员培训报名</a>
