            ...
            <tr>
                ...
                <td valign="top">
                    <div class="content_box">
                        ...
                        <div class="safe_box">
                            <p class="p_boxset"><span>修改邮箱</span></p>
                            <?php if ($data['step'] == 1) { ?>
                            ...
                            <?php } elseif ($data['step'] == 2) { ?>
                                <div class="three_box">
                                    ...
                                    <table cellpadding="0" cellspacing="0" class="tas_s">
                                        <tr>
                                            <td align="right" width="120"><b style="color:#E3393C;">*</b>新的邮箱：</td>
                                            <td><input type="text" name="email" class="w188"/></td>
                                        </tr>
                            ...
                            <?php } elseif ($data['step'] == 3) { ?>
                                <div class="three_box">
                                    ...
                                    <div class="email_success">
                                        ...
                                        <p class="fl cong_get"><span>恭喜您，修改邮箱成功！</span><span
