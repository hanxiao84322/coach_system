...
/**
 * ActivityUsersSearch represents the model behind the search form about `\app\models\ActivityUsers`.
 */
class ActivityUsersSearch extends ActivityUsers
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id', 'activity_id', 'user_id', 'status', 'practice_score', 'theory_score', 'rule_score'], 'integer'],
